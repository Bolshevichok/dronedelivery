...
Создать миссию:
```
& "grpcurl.exe" -plaintext -d '{\"operator_id\":1,\"launch_base_id\":1,\"destination_lat\":55.7558,\"destination_lon\":37.6173,\"destination_alt\":100,\"payload_kg\":1.2}' localhost:8080 mission.v1.MissionService/CreateMission
```
...
стараться делать короткие ключи
